          ...
          <div className="flex justify-between items-center bg-blue-300 px-3 py-5 fixed z-10 w-screen">
              ...
              <div className="flex">
                  ...
                  <ul className='flex justify-between pr-9 items-center'>
                      <li className='px-3 text-white font-medium hover:border-b-2 border-b-0 border-gray-600 border-solid rounded-sm'><a href="#">Home</a></li>
                      ...
                      <li className='px-3 text-3xl text-white font-medium hover:border-b-2 border-b-0 border-gray-600 border-solid rounded-sm'><a href="#"><BiUserCircle/></a></li>
                  </ul>
              </div>
          </div>
    </>
